...
1. **Clone o repositório:**
   ```sh
   git clone https://github.com/Adriano-Severino/Ollama-Code-Diff.git
   cd Ollama-Code-Diff
   ```
...
2. **Instale as dependências:**
   ...
   npm install
   ```
   Isso instalará as dependências do projeto principal.
...
# Testar (abre janela de desenvolvimento)
